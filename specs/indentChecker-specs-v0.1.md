...
The application validates indentation based on the following rules:
...
- **Invalid Encodings**: Skip file with error logging

### File Processing Errors
- **Access Denied**: Log error and continue processing
- **Encoding Issues**: Try alternative encodings or skip
...
- **Path Handling**: Uses .NET path utilities for compatibility
- **Console Output**: Supports colored output on compatible terminals
...
**Generated By**: indentChecker Specifications Generator